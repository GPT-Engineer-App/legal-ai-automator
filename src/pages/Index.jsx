      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <div className="mt-12">
          ...
          <div className="flex justify-center items-center gap-8">
            <img src="/placeholder.svg" alt="Y Combinator" className="h-8" />
            <img src="/placeholder.svg" alt="Benchmark" className="h-8" />
            <img src="/placeholder.svg" alt="Redpoint" className="h-8" />
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                "Collaborating with Mannheimer Swartling"
